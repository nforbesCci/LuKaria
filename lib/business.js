...
export const LOCATIONS = [
  {
    ...
    description: 'Medical care is delivered virtually. This address is for correspondence and verification; it is not a walk-in clinic. In-person visits only by prior arrangement.',
  ...
  },
  {
    ...
    description: 'This address offers in person visits on the above mentioned date and times. These services are delivered through Kids Kidney and Family Care Centre.',
