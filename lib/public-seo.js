...
export const SITE_URL = 'https://svelte.lukariagroup.com';
...
export const routeMetadata = {
  ...
  glp1WeightLoss: {
    ...
    keywords: [
      ...
      'weight loss injections jamaica',
      'Dr. Kadria Fairclough',
    ],
  ...
  svelteSustain: {
    title: 'Svelte Sustain - Weight Maintenance | Svelte by LuKaria',
    description:
      'Svelte Sustain: personalized maintenance care, ongoing support, and expert guidance to help you maintain your results with confidence.',
    keywords: [
      'weight maintenance Jamaica',
      'Svelte Sustain',
      'GLP-1 maintenance',
      'medical weight maintenance',
      'Dr. Kadria Fairclough',
    ],
    path: '/svelte-sustain',
  },
  weightLossInjections: {
    title: 'Weight Loss Injections in Jamaica | Physician-Supervised',
    description:
      'Physician-supervised weight loss injections in Jamaica. Explore GLP-1 medications like Semaglutide (Ozempic) and Tirzepatide (Mounjaro) with Dr. Kadria Fairclough at Svelte by LuKaria.',
    keywords: [
      'weight loss injections Jamaica',
      'weight loss injections',
      'injectable weight loss Jamaica',
      'injectables',
      'injectables Jamaica',
      'Weight loss injectables',
      'Weight loss injectables jamaica',
      'GLP-1 injections',
      'medical weight loss Jamaica',
