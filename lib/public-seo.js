...
export const routeMetadata = {
  ...
  glp1WeightLoss: {
    title: 'GLP-1 Weight Loss Jamaica',
    description:
      'Doctor-guided GLP-1 weight loss in Jamaica. Learn how semaglutide and tirzepatide treatment plans work at Svelte by LuKaria with safe physician supervision.',
    keywords: [
  ...
  ozempicSemaglutide: {
    title: 'Ozempic & Semaglutide Weight Loss Jamaica',
    description:
      'Physician-supervised Ozempic and semaglutide for weight management in Jamaica. Doctor-guided virtual care with Dr. Kadria Fairclough at Svelte by LuKaria.',
    keywords: [
      'Ozempic Jamaica',
      'semaglutide Jamaica',
      'Ozempic weight loss',
  ...
  mounjaroTirzepatide: {
    title: 'Mounjaro & Tirzepatide Weight Loss Jamaica',
    description:
      'Physician-supervised Mounjaro and tirzepatide for weight management in Jamaica. Doctor-guided virtual care with Dr. Kadria Fairclough at Svelte by LuKaria.',
    keywords: [
      'Mounjaro Jamaica',
      'tirzepatide Jamaica',
