...
export const routeMetadata = {
  ...
  contact: {
    ...
    description:
      'Contact Svelte by LuKaria for medical weight loss Jamaica. Get in touch about doctor-guided GLP-1 weight loss, Ozempic, Mounjaro, Tirzepatide consultations and program enrollment.',
    keywords: [
