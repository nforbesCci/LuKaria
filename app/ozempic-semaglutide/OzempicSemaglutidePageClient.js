...
export default function OzempicSemaglutidePageClient() {
  const schema = {
    ...
    name: 'Doctor-guided semaglutide (Ozempic) weight loss',
    ...
    url: 'https://www.lukariagroup.com/ozempic-semaglutide',
    description:
      'Physician-supervised semaglutide weight management in Jamaica—virtual follow-up and individualized planning with Dr. Kadria Fairclough.',
  };

  return (
    <>
      <PublicTopMenu currentPath="/ozempic-semaglutide" />
      <PublicTopBar />
      <Container maxWidth="lg" sx={{ mt: 14, mb: 8 }}>
          ...
          <Grid item xs={12} md={4}>
            <Paper variant="outlined" sx={{ p: 2.5, height: '100%', borderColor: '#877449' }}>
              ...
              <Typography variant="body2" sx={{ color: '#333' }}>
                Semaglutide acts on GLP-1 pathways to help regulate appetite and support metabolic goals when combined with
                physician-directed lifestyle change—not as a standalone quick fix.
              </Typography>
            </Paper>
          </Grid>
          <Grid item xs={12} md={4}>
            <Paper variant="outlined" sx={{ p: 2.5, height: '100%', borderColor: '#877449' }}>
              ...
              <Typography variant="body2" sx={{ color: '#333' }}>
                Adults who need evidence-based weight management and meet clinical criteria after a full assessment.
                Your doctor decides if semaglutide is appropriate and at what dose.
              </Typography>
            </Paper>
          </Grid>
          <Grid item xs={12} md={4}>
            <Paper variant="outlined" sx={{ p: 2.5, height: '100%', borderColor: '#877449' }}>
              ...
              <Typography variant="body2" sx={{ color: '#333' }}>
                Regular telehealth reviews, dose adjustments, and safety checks keep treatment aligned with your health and
                goals.
              </Typography>
            </Paper>
          </Grid>
        ...
        <Paper variant="outlined" sx={{ p: 3, borderColor: '#877449', mb: 4 }}>
          ...
          <Typography variant="body1" sx={{ color: '#333', lineHeight: 1.75 }}>
            ...
            to tailor treatment safely for each patient—whether that includes semaglutide or another plan.&quot;
        </Typography>
      </Paper>
