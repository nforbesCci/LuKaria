...
export default function FAQ() {
  ...
  const [activeTab, setActiveTab] = useState(2); // Default to Ozempic (index 2)
        ...
        <Container maxWidth="lg" sx={{ mt: 16, mb: 4 }}>
          ...
          <Box sx={{ maxWidth: 800, mx: 'auto' }}>
            ...
            {activeTab === 1 && (
              <Box>
                <Accordion 
                  expanded={expandedPanel === 'wegovy-what'}
                  onChange={handleAccordionChange('wegovy-what')}
                  sx={{ 
                    backgroundColor: '#36454F',
                    color: 'white',
                    '&:before': { display: 'none' },
                ...
                >
                  <AccordionSummary
                    expandIcon={<ExpandMore sx={{ color: '#D4AF37' }} />}
                    aria-controls="wegovy-what-content"
                    id="wegovy-what-header"
                    sx={{ 
                      backgroundColor: '#36454F',
                      color: 'white',
                      '&:hover': { backgroundColor: '#2C3E50' }
                  ...
                  <AccordionDetails sx={{ backgroundColor: '#36454F', color: 'white' }}>
                    <Typography variant="body1" sx={{ lineHeight: 1.6, color: 'white' }}>
                      Wegovy (Semaglutide) is a human-based glucagon-like peptide-1 receptor agonist (GLP1- RA) prescribed as an adjunct to a reduced calorie diet and increased physical activity for chronic weight management in adults with an initial body mass index (BMI) that is considered outside a healthy range.
                    </Typography>
                  </AccordionDetails>
                </Accordion>

                <Accordion
                  expanded={expandedPanel === 'wegovy-how-works'}
                  onChange={handleAccordionChange('wegovy-how-works')}
                  sx={{ 
                    backgroundColor: '#36454F',
                    color: 'white',
                    '&:before': { display: 'none' },
                ...
                >
                  <AccordionSummary
                    expandIcon={<ExpandMore sx={{ color: '#D4AF37' }} />}
                    aria-controls="wegovy-how-works-content"
                    id="wegovy-how-works-header"
                    sx={{ 
                      backgroundColor: '#36454F',
                      color: 'white',
                      '&:hover': { backgroundColor: '#2C3E50' }
                  ...
                  <AccordionDetails sx={{ backgroundColor: '#36454F', color: 'white' }}>
                    <Typography variant="body1" sx={{ lineHeight: 1.6, color: 'white' }}>
                      Wegovy works by slowing gastric emptying time and stimulating the satiety center in the brain to reduce hunger and appetite.
                    </Typography>
                  </AccordionDetails>
                </Accordion>

                <Accordion
                  expanded={expandedPanel === 'wegovy-how-take'}
                  onChange={handleAccordionChange('wegovy-how-take')}
                  sx={{ 
                    backgroundColor: '#36454F',
                    color: 'white',
                    '&:before': { display: 'none' },
                ...
                >
                  <AccordionSummary
                    expandIcon={<ExpandMore sx={{ color: '#D4AF37' }} />}
                    aria-controls="wegovy-how-take-content"
                    id="wegovy-how-take-header"
                    sx={{ 
                      backgroundColor: '#36454F',
                      color: 'white',
                      '&:hover': { backgroundColor: '#2C3E50' }
                  ...
                  <AccordionDetails sx={{ backgroundColor: '#36454F', color: 'white' }}>
                    <Typography variant="body1" sx={{ lineHeight: 1.6, color: 'white' }}>
                      Wegovy is injected under the skin 1 time each week at any time of the day. It may be injected under the skin of the abdomen, thigh or back of the arm. You should alternate the injection site with each injection.
                    </Typography>
                  </AccordionDetails>
                </Accordion>

                <Accordion
                  expanded={expandedPanel === 'wegovy-weight-loss'}
                  onChange={handleAccordionChange('wegovy-weight-loss')}
                  sx={{ 
                    backgroundColor: '#36454F',
                    color: 'white',
                    '&:before': { display: 'none' },
                ...
                >
                  <AccordionSummary
                    expandIcon={<ExpandMore sx={{ color: '#D4AF37' }} />}
                    aria-controls="wegovy-weight-loss-content"
                    id="wegovy-weight-loss-header"
                    sx={{ 
                      backgroundColor: '#36454F',
                      color: 'white',
                      '&:hover': { backgroundColor: '#2C3E50' }
                  ...
                  >
                    <Typography variant="h6" sx={{ fontWeight: 600, color: '#D4AF37' }}>
                      How much weight can I lose while taking Wegovy?
                    </Typography>
                  </AccordionSummary>
                  <AccordionDetails sx={{ backgroundColor: '#36454F', color: 'white' }}>
                    <Typography variant="body1" sx={{ lineHeight: 1.6, color: 'white' }}>
                      Individual results vary. In studies, adults taking Wegovy lost up to 20% of their body weight.
                    </Typography>
                  </AccordionDetails>
                </Accordion>

                <Accordion
                  expanded={expandedPanel === 'wegovy-side-effects'}
                  onChange={handleAccordionChange('wegovy-side-effects')}
                  sx={{ 
                    backgroundColor: '#36454F',
                    color: 'white',
                    '&:before': { display: 'none' },
                ...
                >
                  <AccordionSummary
                    expandIcon={<ExpandMore sx={{ color: '#D4AF37' }} />}
                    aria-controls="wegovy-side-effects-content"
                    id="wegovy-side-effects-header"
                    sx={{ 
                      backgroundColor: '#36454F',
                      color: 'white',
                      '&:hover': { backgroundColor: '#2C3E50' }
            ...
            {activeTab === 2 && (
              <Box>
                <Accordion 
                  expanded={expandedPanel === 'ozempic'}
                  onChange={handleAccordionChange('ozempic')}
                  sx={{ 
                    backgroundColor: '#36454F',
                    color: 'white',
                    '&:before': { display: 'none' },
            ...
            <AccordionDetails sx={{ backgroundColor: '#36454F', color: 'white' }}>
              <Typography variant="body1" sx={{ lineHeight: 1.6, color: 'white' }}>
                Ozempic (Semaglutide) is a human-based glucagon-like peptide-1 receptor agonist (GLP1- RA) prescribed as an adjunct to a reduced calorie diet and increased physical activity for chronic weight management in adults with an initial body mass index (BMI) that is considered outside a healthy range.
              </Typography>
            </AccordionDetails>
          </Accordion>

          <Accordion
            expanded={expandedPanel === 'how-works'}
            onChange={handleAccordionChange('how-works')}
            sx={{ 
              backgroundColor: '#36454F',
              color: 'white',
              '&:before': { display: 'none' },
          ...
          >
            <AccordionSummary
              expandIcon={<ExpandMore sx={{ color: '#D4AF37' }} />}
              aria-controls="how-works-content"
              id="how-works-header"
              sx={{ 
                backgroundColor: '#36454F',
                color: 'white',
            ...
            <AccordionDetails sx={{ backgroundColor: '#36454F', color: 'white' }}>
              <Typography variant="body1" sx={{ lineHeight: 1.6, color: 'white' }}>
                Ozempic works by slowing gastric emptying time and stimulating the satiety center in the brain to reduce hunger and appetite.
              </Typography>
            </AccordionDetails>
          </Accordion>

          <Accordion
            expanded={expandedPanel === 'how-take'}
            onChange={handleAccordionChange('how-take')}
            sx={{ 
              backgroundColor: '#36454F',
              color: 'white',
              '&:before': { display: 'none' },
          ...
          >
            <AccordionSummary
              expandIcon={<ExpandMore sx={{ color: '#D4AF37' }} />}
              aria-controls="how-take-content"
              id="how-take-header"
              sx={{ 
                backgroundColor: '#36454F',
                color: 'white',
            ...
            <AccordionDetails sx={{ backgroundColor: '#36454F', color: 'white' }}>
              <Typography variant="body1" sx={{ lineHeight: 1.6, color: 'white' }}>
                Ozempic is injected under the skin 1 time each week at any time of the day. It may be injected under the skin of the abdomen, thigh or back of the arm. You should alternate the injection site with each injection.
              </Typography>
            </AccordionDetails>
          </Accordion>

          <Accordion
            expanded={expandedPanel === 'weight-loss'}
            onChange={handleAccordionChange('weight-loss')}
            sx={{ 
              backgroundColor: '#36454F',
              color: 'white',
              '&:before': { display: 'none' },
          ...
          >
            <AccordionSummary
              expandIcon={<ExpandMore sx={{ color: '#D4AF37' }} />}
              aria-controls="weight-loss-content"
              id="weight-loss-header"
              sx={{ 
                backgroundColor: '#36454F',
                color: 'white',
                '&:hover': { backgroundColor: '#2C3E50' }
            ...
            >
              <Typography variant="h6" sx={{ fontWeight: 600, color: '#D4AF37' }}>
                How much weight can I lose while taking Ozempic?
              </Typography>
            </AccordionSummary>
            <AccordionDetails sx={{ backgroundColor: '#36454F', color: 'white' }}>
              <Typography variant="body1" sx={{ lineHeight: 1.6, color: 'white' }}>
                Individual results vary. In studies, adults taking Ozempic lost up to 20% of their body weight.
              </Typography>
            </AccordionDetails>
          </Accordion>

          <Accordion
            expanded={expandedPanel === 'side-effects'}
            onChange={handleAccordionChange('side-effects')}
            sx={{ 
              backgroundColor: '#36454F',
              color: 'white',
              '&:before': { display: 'none' },
          ...
          >
            <AccordionSummary
              expandIcon={<ExpandMore sx={{ color: '#D4AF37' }} />}
              aria-controls="side-effects-content"
              id="side-effects-header"
              sx={{ 
                backgroundColor: '#36454F',
                color: 'white',
                '&:hover': { backgroundColor: '#2C3E50' }
