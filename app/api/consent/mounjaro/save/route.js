...
export async function POST(request) {
  try {
    ...
    console.log('✅ Mounjaro consent saved successfully. Complete:', document.complete, 'Result:', result);

    return NextResponse.json({
      success: true,
      message: 'Mounjaro consent saved successfully',
      data: document,
    });

  } catch (error) {
    console.error('❌ Error saving mounjaro consent:', error);
    return NextResponse.json(
      { 
        error: 'Failed to save mounjaro consent',
